...
Usage (writes to stdout by default):
    ...
    .venv/bin/python3 -m scripts.disagreement_report --db Dank-EXP-02.declarative.db > report.md

Or with an explicit output path:

    .venv/bin/python3 -m scripts.disagreement_report --db ... --out render_batch/m7_disagreement_report.md
"""
