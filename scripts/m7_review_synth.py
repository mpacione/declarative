...
Usage::
    ...
    python3 -m scripts.m7_review_synth list
    python3 -m scripts.m7_review_synth show tier_d_report-20260421-001
    python3 -m scripts.m7_review_synth reject tier_d_report-20260421-001 \\
        --reason "button variant should be destructive, not secondary"
    python3 -m scripts.m7_review_synth decisions  # show log
"""
