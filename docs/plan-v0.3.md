...
| M2 | Script ratio-parity ≥ 0.95 with the pre-markup renderer on 3 reference fixtures (181 / 222 / 237) | ✅ 0.978–0.984 post M2e | Full byte-parity is deferred to M2+ / M3; ratio-parity (≥ 0.95) is the operational gate |
