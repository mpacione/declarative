...
n3.appendChild(n15);
try { n15.characters = "Resolution: 2796 x 1290 pixels"; } catch (__e) { __errors.push({eid:"text-5", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n4.appendChild(n17);
try { n17.characters = "Camera System"; } catch (__e) { __errors.push({eid:"heading-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n4.appendChild(n20);
try { n20.characters = "Night Mode, ProRAW, ProRes Video"; } catch (__e) { __errors.push({eid:"text-9", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n26.appendChild(n30);
try { n30.characters = "5G Support"; } catch (__e) { __errors.push({eid:"text-13", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n30.layoutSizingHorizontal = "FILL";
n27.appendChild(n31);
try { n31.characters = "Face ID"; } catch (__e) { __errors.push({eid:"text-14", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n31.layoutSizingHorizontal = "FILL";
n28.appendChild(n32);
try { n32.characters = "IP68 Water Resistance"; } catch (__e) { __errors.push({eid:"text-15", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n32.layoutSizingHorizontal = "FILL";
n29.appendChild(n33);
try { n33.characters = "MagSafe"; } catch (__e) { __errors.push({eid:"text-16", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
