...
n18.appendChild(n33);
try { n33.characters = "Subscription renewal"; } catch (__e) { __errors.push({eid:"text-19", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n33.layoutSizingHorizontal = "FILL";
n18.appendChild(n34);
try { n34.characters = "$99.00"; } catch (__e) { __errors.push({eid:"text-20", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n19.appendChild(n38);
try { n38.characters = "$3,200.00"; } catch (__e) { __errors.push({eid:"text-24", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
