...
n30.name = "text-13";
try { n30.fontName = {family: "Inter", style: "Regular"}; } catch (__e) { __errors.push({eid:"text-13", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n30.fontSize = 14;
M["text-13"] = n30.id;

const n31 = figma.createText();
n31.name = "text-14";
try { n31.fontName = {family: "Inter", style: "Regular"}; } catch (__e) { __errors.push({eid:"text-14", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n31.fontSize = 14;
M["text-14"] = n31.id;

const n32 = figma.createText();
n32.name = "text-15";
try { n32.fontName = {family: "Inter", style: "Regular"}; } catch (__e) { __errors.push({eid:"text-15", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n32.fontSize = 14;
M["text-15"] = n32.id;

const n33 = figma.createText();
n33.name = "text-16";
try { n33.fontName = {family: "Inter", style: "Regular"}; } catch (__e) { __errors.push({eid:"text-16", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n33.fontSize = 14;
M["text-16"] = n33.id;
...
n3.appendChild(n14);
try { n14.characters = "6.7-inch Super Retina XDR display"; } catch (__e) { __errors.push({eid:"text-4", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n14.layoutSizingHorizontal = "FILL";
n3.appendChild(n15);
try { n15.characters = "Resolution: 2796 × 1290 pixels"; } catch (__e) { __errors.push({eid:"text-5", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n15.layoutSizingHorizontal = "FILL";
n3.appendChild(n16);
try { n16.characters = "ProMotion 120Hz"; } catch (__e) { __errors.push({eid:"text-6", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n4.appendChild(n18);
try { n18.characters = "Rear: 12MP Wide, Ultra Wide, Telephoto"; } catch (__e) { __errors.push({eid:"text-7", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n4.appendChild(n20);
try { n20.characters = "Video: 4K at up to 60fps, ProRes"; } catch (__e) { __errors.push({eid:"text-9", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n5.appendChild(n22);
try { n22.characters = "Processor: A15 Bionic"; } catch (__e) { __errors.push({eid:"text-10", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n5.appendChild(n24);
try { n24.characters = "Battery: 4352 mAh, up to 28 hours"; } catch (__e) { __errors.push({eid:"text-12", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n24.layoutSizingHorizontal = "FILL";
n6.appendChild(n25);
try { n25.characters = "Features"; } catch (__e) { __errors.push({eid:"heading-5", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n26.appendChild(n30);
try { n30.characters = "Face ID"; } catch (__e) { __errors.push({eid:"text-13", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n30.layoutSizingHorizontal = "FILL";
n27.appendChild(n31);
try { n31.characters = "5G"; } catch (__e) { __errors.push({eid:"text-14", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n31.layoutSizingHorizontal = "FILL";
n28.appendChild(n32);
try { n32.characters = "Ceramic Shield"; } catch (__e) { __errors.push({eid:"text-15", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n32.layoutSizingHorizontal = "FILL";
n29.appendChild(n33);
try { n33.characters = "IP68 Water Resistant"; } catch (__e) { __errors.push({eid:"text-16", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
