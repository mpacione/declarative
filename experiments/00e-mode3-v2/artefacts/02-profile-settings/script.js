...
n7.fills = [{type: "SOLID", color: {r:0.9725,g:0.9804,b:0.9882}}];
n7.cornerRadius = 8;
...
n2.appendChild(n8);
try { n8.characters = "John Doe"; } catch (__e) { __errors.push({eid:"heading-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n8.layoutSizingHorizontal = "FILL";
n2.appendChild(n9);
try { n9.characters = "john.doe@example.com"; } catch (__e) { __errors.push({eid:"text-2", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n11.appendChild(n15);
try { n15.characters = "Push notifications"; } catch (__e) { __errors.push({eid:"text-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n15.layoutSizingHorizontal = "FILL";
n12.appendChild(n16);
try { n16.characters = "Email notifications"; } catch (__e) { __errors.push({eid:"text-4", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n16.layoutSizingHorizontal = "FILL";
n13.appendChild(n17);
try { n17.characters = "SMS notifications"; } catch (__e) { __errors.push({eid:"text-5", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n17.layoutSizingHorizontal = "FILL";
n14.appendChild(n18);
try { n18.characters = "Marketing emails"; } catch (__e) { __errors.push({eid:"text-6", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
