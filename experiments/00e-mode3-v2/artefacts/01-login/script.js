...
n5.name = "link-1";
n5.fills = [{type: "SOLID", color: {r:0.9725,g:0.9804,b:0.9882}}];
...
n10.name = "text-6";
try { n10.fontName = {family: "Inter", style: "Regular"}; } catch (__e) { __errors.push({eid:"text-6", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n10.fontSize = 14;
M["text-6"] = n10.id;
...
n0.appendChild(n5);
try { n5.characters = "Forgot password?"; } catch (__e) { __errors.push({eid:"link-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n5.appendChild(n10);
try { n10.characters = "Forgot password?"; } catch (__e) { __errors.push({eid:"text-6", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
