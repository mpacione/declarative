...
n25.fills = [{type: "SOLID", color: {r:0.9451,g:0.9608,b:0.9765}}];
...
n29.fills = [{type: "SOLID", color: {r:0.9451,g:0.9608,b:0.9765}}];
...
n30.name = "text-17";
try { n30.fontName = {family: "Inter", style: "Regular"}; } catch (__e) { __errors.push({eid:"text-17", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
M["text-17"] = n30.id;
...
try { n34.fontName = {family: "Inter", style: "Semi Bold"}; } catch (__e) { __errors.push({eid:"text-8", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n34.fontSize = 12;
M["text-8"] = n34.id;
...
try { n36.fontName = {family: "Inter", style: "Semi Bold"}; } catch (__e) { __errors.push({eid:"text-16", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n36.fontSize = 12;
M["text-16"] = n36.id;
...
try { n37.fontName = {family: "Inter", style: "Semi Bold"}; } catch (__e) { __errors.push({eid:"text-20", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n37.fontSize = 12;
M["text-20"] = n37.id;
...
n3.appendChild(n9);
n9.appendChild(n10);
try { n10.characters = "Date"; } catch (__e) { __errors.push({eid:"text-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n10.layoutSizingHorizontal = "FILL";
n9.appendChild(n11);
try { n11.characters = "Description"; } catch (__e) { __errors.push({eid:"text-2", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n11.layoutSizingHorizontal = "FILL";
n9.appendChild(n12);
try { n12.characters = "Amount"; } catch (__e) { __errors.push({eid:"text-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n12.layoutSizingHorizontal = "FILL";
n9.appendChild(n13);
try { n13.characters = "Status"; } catch (__e) { __errors.push({eid:"text-4", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n9.appendChild(n17);
n14.appendChild(n18);
try { n18.characters = "2024-01-15"; } catch (__e) { __errors.push({eid:"text-5", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n18.layoutSizingHorizontal = "FILL";
n14.appendChild(n19);
try { n19.characters = "Payment received"; } catch (__e) { __errors.push({eid:"text-6", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n19.layoutSizingHorizontal = "FILL";
n14.appendChild(n20);
try { n20.characters = "$1,250.00"; } catch (__e) { __errors.push({eid:"text-7", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n20.layoutSizingHorizontal = "FILL";
n14.appendChild(n21);
n21.layoutSizingHorizontal = "HUG";
n21.layoutSizingVertical = "HUG";
n15.appendChild(n22);
try { n22.characters = "2024-01-14"; } catch (__e) { __errors.push({eid:"text-9", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n22.layoutSizingHorizontal = "FILL";
n15.appendChild(n23);
try { n23.characters = "Invoice #2024-001"; } catch (__e) { __errors.push({eid:"text-10", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n23.layoutSizingHorizontal = "FILL";
n15.appendChild(n24);
try { n24.characters = "$2,500.00"; } catch (__e) { __errors.push({eid:"text-11", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n24.layoutSizingHorizontal = "FILL";
n15.appendChild(n25);
n25.layoutSizingHorizontal = "HUG";
n25.layoutSizingVertical = "HUG";
n16.appendChild(n26);
try { n26.characters = "2024-01-13"; } catch (__e) { __errors.push({eid:"text-13", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n26.layoutSizingHorizontal = "FILL";
n16.appendChild(n27);
try { n27.characters = "Refund"; } catch (__e) { __errors.push({eid:"text-14", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n27.layoutSizingHorizontal = "FILL";
n16.appendChild(n28);
try { n28.characters = "-$150.00"; } catch (__e) { __errors.push({eid:"text-15", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n28.layoutSizingHorizontal = "FILL";
n16.appendChild(n29);
n29.layoutSizingHorizontal = "HUG";
n29.layoutSizingVertical = "HUG";
n17.appendChild(n30);
try { n30.characters = "2024-01-12"; } catch (__e) { __errors.push({eid:"text-17", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n30.layoutSizingHorizontal = "FILL";
n17.appendChild(n31);
try { n31.characters = "Subscription renewal"; } catch (__e) { __errors.push({eid:"text-18", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n31.layoutSizingHorizontal = "FILL";
n17.appendChild(n32);
try { n32.characters = "$99.00"; } catch (__e) { __errors.push({eid:"text-19", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n32.layoutSizingHorizontal = "FILL";
n17.appendChild(n33);
n33.layoutSizingHorizontal = "HUG";
n33.layoutSizingVertical = "HUG";
n21.appendChild(n34);
try { n34.characters = "Completed"; } catch (__e) { __errors.push({eid:"text-8", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n34.layoutSizingHorizontal = "FILL";
n25.appendChild(n35);
try { n35.characters = "Completed"; } catch (__e) { __errors.push({eid:"text-12", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n35.layoutSizingHorizontal = "FILL";
n29.appendChild(n36);
try { n36.characters = "Pending"; } catch (__e) { __errors.push({eid:"text-16", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n36.layoutSizingHorizontal = "FILL";
n33.appendChild(n37);
try { n37.characters = "Completed"; } catch (__e) { __errors.push({eid:"text-20", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
