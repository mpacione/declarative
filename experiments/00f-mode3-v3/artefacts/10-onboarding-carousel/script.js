...
n2.appendChild(n10);
try { n10.characters = "Discover amazing features and get started in seconds"; } catch (__e) { __errors.push({eid:"text-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n3.appendChild(n13);
try { n13.characters = "Everything you need to succeed, all in one place"; } catch (__e) { __errors.push({eid:"text-2", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n4.appendChild(n16);
try { n16.characters = "Create your account and unlock endless possibilities"; } catch (__e) { __errors.push({eid:"text-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
