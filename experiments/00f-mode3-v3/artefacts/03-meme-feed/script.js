...
n8.name = "button_group-1";
n8.layoutMode = "VERTICAL";
n8.fills = [];
n8.clipsContent = false;
M["button_group-1"] = n8.id;
...
n12.name = "button_group-3";
n12.layoutMode = "VERTICAL";
n12.fills = [];
n12.clipsContent = false;
M["button_group-3"] = n12.id;

const n13 = await (async () => { const __src = _p1; if (!__src) { __errors.push({eid:"button-1", kind:"missing_component_node", id:"5749:82461"}); return _missingComponentPlaceholder("button-1", 24, 24, "button-1"); } try { return __src.createInstance(); } catch (__e) { __errors.push({eid:"button-1", kind:"create_instance_failed", id:"5749:82461", error: String(__e && __e.message || __e)}); return _missingComponentPlaceholder("button-1", 24, 24, "button-1"); } })();
n13.name = "button-1";
{ const _t = n13.findOne(n => n.type === "TEXT" && /^(title|label|heading)$/i.test(n.name)) || n13.findOne(n => n.type === "TEXT"); if (_t) { await figma.loadFontAsync(_t.fontName); _t.characters = "👍 Upvote"; } }
M["button-1"] = n13.id;

const n14 = await (async () => { const __src = _p1; if (!__src) { __errors.push({eid:"button-2", kind:"missing_component_node", id:"5749:82461"}); return _missingComponentPlaceholder("button-2", 24, 24, "button-2"); } try { return __src.createInstance(); } catch (__e) { __errors.push({eid:"button-2", kind:"create_instance_failed", id:"5749:82461", error: String(__e && __e.message || __e)}); return _missingComponentPlaceholder("button-2", 24, 24, "button-2"); } })();
n14.name = "button-2";
{ const _t = n14.findOne(n => n.type === "TEXT" && /^(title|label|heading)$/i.test(n.name)) || n14.findOne(n => n.type === "TEXT"); if (_t) { await figma.loadFontAsync(_t.fontName); _t.characters = "Share"; } }
M["button-2"] = n14.id;

const n15 = await (async () => { const __src = _p1; if (!__src) { __errors.push({eid:"button-3", kind:"missing_component_node", id:"5749:82461"}); return _missingComponentPlaceholder("button-3", 24, 24, "button-3"); } try { return __src.createInstance(); } catch (__e) { __errors.push({eid:"button-3", kind:"create_instance_failed", id:"5749:82461", error: String(__e && __e.message || __e)}); return _missingComponentPlaceholder("button-3", 24, 24, "button-3"); } })();
n15.name = "button-3";
{ const _t = n15.findOne(n => n.type === "TEXT" && /^(title|label|heading)$/i.test(n.name)) || n15.findOne(n => n.type === "TEXT"); if (_t) { await figma.loadFontAsync(_t.fontName); _t.characters = "👍 Upvote"; } }
M["button-3"] = n15.id;

const n16 = await (async () => { const __src = _p1; if (!__src) { __errors.push({eid:"button-4", kind:"missing_component_node", id:"5749:82461"}); return _missingComponentPlaceholder("button-4", 24, 24, "button-4"); } try { return __src.createInstance(); } catch (__e) { __errors.push({eid:"button-4", kind:"create_instance_failed", id:"5749:82461", error: String(__e && __e.message || __e)}); return _missingComponentPlaceholder("button-4", 24, 24, "button-4"); } })();
n16.name = "button-4";
{ const _t = n16.findOne(n => n.type === "TEXT" && /^(title|label|heading)$/i.test(n.name)) || n16.findOne(n => n.type === "TEXT"); if (_t) { await figma.loadFontAsync(_t.fontName); _t.characters = "Share"; } }
M["button-4"] = n16.id;

const n17 = await (async () => { const __src = _p1; if (!__src) { __errors.push({eid:"button-5", kind:"missing_component_node", id:"5749:82461"}); return _missingComponentPlaceholder("button-5", 24, 24, "button-5"); } try { return __src.createInstance(); } catch (__e) { __errors.push({eid:"button-5", kind:"create_instance_failed", id:"5749:82461", error: String(__e && __e.message || __e)}); return _missingComponentPlaceholder("button-5", 24, 24, "button-5"); } })();
n17.name = "button-5";
{ const _t = n17.findOne(n => n.type === "TEXT" && /^(title|label|heading)$/i.test(n.name)) || n17.findOne(n => n.type === "TEXT"); if (_t) { await figma.loadFontAsync(_t.fontName); _t.characters = "👍 Upvote"; } }
M["button-5"] = n17.id;

const n18 = await (async () => { const __src = _p1; if (!__src) { __errors.push({eid:"button-6", kind:"missing_component_node", id:"5749:82461"}); return _missingComponentPlaceholder("button-6", 24, 24, "button-6"); } try { return __src.createInstance(); } catch (__e) { __errors.push({eid:"button-6", kind:"create_instance_failed", id:"5749:82461", error: String(__e && __e.message || __e)}); return _missingComponentPlaceholder("button-6", 24, 24, "button-6"); } })();
n18.name = "button-6";
{ const _t = n18.findOne(n => n.type === "TEXT" && /^(title|label|heading)$/i.test(n.name)) || n18.findOne(n => n.type === "TEXT"); if (_t) { await figma.loadFontAsync(_t.fontName); _t.characters = "Share"; } }
M["button-6"] = n18.id;
