...
n0.appendChild(n7);
n3.appendChild(n8);
try { n8.characters = "Welcome Back"; } catch (__e) { __errors.push({eid:"heading-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n8.layoutSizingHorizontal = "FILL";
n3.appendChild(n9);
try { n9.characters = "Continue your journey to relaxation"; } catch (__e) { __errors.push({eid:"text-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n9.layoutSizingHorizontal = "FILL";
n4.appendChild(n10);
try { n10.characters = "Featured Services"; } catch (__e) { __errors.push({eid:"heading-2", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n10.layoutSizingHorizontal = "FILL";
n4.appendChild(n11);
n5.appendChild(n12);
try { n12.characters = "Your Next Appointment"; } catch (__e) { __errors.push({eid:"heading-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n12.layoutSizingHorizontal = "FILL";
n5.appendChild(n13);
try { n13.characters = "No appointments scheduled"; } catch (__e) { __errors.push({eid:"text-2", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n13.layoutSizingHorizontal = "FILL";
n5.appendChild(n14);
n6.appendChild(n15);
try { n15.characters = "Membership"; } catch (__e) { __errors.push({eid:"heading-4", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
try { n2.x = 0; } catch (__e) { __errors.push({eid:"image-1", kind:"position_failed", error: String(__e && __e.message || __e)}); }
try { n2.y = 50; } catch (__e) { __errors.push({eid:"image-1", kind:"position_failed", error: String(__e && __e.message || __e)}); }
...
try { n7.x = 0; } catch (__e) { __errors.push({eid:"bottom_nav-1", kind:"position_failed", error: String(__e && __e.message || __e)}); }
try { n7.y = 300; } catch (__e) { __errors.push({eid:"bottom_nav-1", kind:"position_failed", error: String(__e && __e.message || __e)}); }
} catch (__thrown) {
