...
n19.name = "segmented_control-1";
n19.layoutMode = "VERTICAL";
n19.fills = [];
n19.clipsContent = false;
M["segmented_control-1"] = n19.id;

const n20 = figma.createText();
n20.name = "heading-5";
try { n20.fontName = {family: "Inter", style: "Regular"}; } catch (__e) { __errors.push({eid:"heading-5", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
M["heading-5"] = n20.id;

const n21 = figma.createFrame();
n21.name = "segmented_control-2";
n21.layoutMode = "VERTICAL";
n21.fills = [];
n21.clipsContent = false;
M["segmented_control-2"] = n21.id;
...
n2.appendChild(n9);
n2.appendChild(n10);
try { n10.characters = "iPhone 13 Pro Max"; } catch (__e) { __errors.push({eid:"heading-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n10.layoutSizingHorizontal = "FILL";
n2.appendChild(n11);
try { n11.characters = "Stunning camera. Unforgettable power. All-day battery life."; } catch (__e) { __errors.push({eid:"text-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n11.layoutSizingHorizontal = "FILL";
n3.appendChild(n12);
try { n12.characters = "Key Features"; } catch (__e) { __errors.push({eid:"heading-2", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n12.layoutSizingHorizontal = "FILL";
n3.appendChild(n13);
n4.appendChild(n14);
try { n14.characters = "Specs"; } catch (__e) { __errors.push({eid:"heading-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n14.layoutSizingHorizontal = "FILL";
n4.appendChild(n15);
try { n15.characters = "Storage: 128GB, 256GB, 512GB, 1TB"; } catch (__e) { __errors.push({eid:"text-2", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n15.layoutSizingHorizontal = "FILL";
n4.appendChild(n16);
try { n16.characters = "Colors: Sierra Blue, Gold, Silver, Deep Purple"; } catch (__e) { __errors.push({eid:"text-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n16.layoutSizingHorizontal = "FILL";
n4.appendChild(n17);
try { n17.characters = "Battery: Up to 28 hours video playback"; } catch (__e) { __errors.push({eid:"text-4", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n17.layoutSizingHorizontal = "FILL";
n5.appendChild(n18);
try { n18.characters = "Select Storage"; } catch (__e) { __errors.push({eid:"heading-4", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n18.layoutSizingHorizontal = "FILL";
n5.appendChild(n19);
n6.appendChild(n20);
try { n20.characters = "Select Color"; } catch (__e) { __errors.push({eid:"heading-5", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
try { n6.x = 0; } catch (__e) { __errors.push({eid:"card-5", kind:"position_failed", error: String(__e && __e.message || __e)}); }
try { n6.y = 250; } catch (__e) { __errors.push({eid:"card-5", kind:"position_failed", error: String(__e && __e.message || __e)}); }
try { n7.x = 0; } catch (__e) { __errors.push({eid:"button-1", kind:"position_failed", error: String(__e && __e.message || __e)}); }
try { n7.y = 300; } catch (__e) { __errors.push({eid:"button-1", kind:"position_failed", error: String(__e && __e.message || __e)}); }
try { n8.x = 0; } catch (__e) { __errors.push({eid:"button-2", kind:"position_failed", error: String(__e && __e.message || __e)}); }
try { n8.y = 350; } catch (__e) { __errors.push({eid:"button-2", kind:"position_failed", error: String(__e && __e.message || __e)}); }
} catch (__thrown) {
