...
n3.appendChild(n8);
n4.appendChild(n9);
try { n9.characters = "Filters"; } catch (__e) { __errors.push({eid:"heading-2", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n9.layoutSizingHorizontal = "FILL";
n4.appendChild(n10);
n4.appendChild(n11);
n4.appendChild(n12);
n5.appendChild(n13);
try { n13.characters = "Results"; } catch (__e) { __errors.push({eid:"heading-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
