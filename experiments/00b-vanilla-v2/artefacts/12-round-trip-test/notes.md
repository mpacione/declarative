...
- types: `{'header': 1, 'card': 4, 'image': 1, 'heading': 4, 'text': 1, 'list': 1, 'list_item': 4, 'navigation_row': 4, 'button_group': 1, 'button': 5}`

## Compose (IR)

- elements: 27
- types: `{'header': 1, 'image': 1, 'heading': 4, 'text': 1, 'card': 4, 'list_item': 4, 'list': 1, 'navigation_row': 4, 'button': 5, 'button_group': 1, 'screen': 1}`
- warnings (Mode 2 fallbacks): 26
- token refs: 0
- script chars: 8,808
- createInstance count (Mode 1): 0
- createText count: 5
- createFrame count: 22
