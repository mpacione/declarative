...
- component count (flat): 14
- types: `{'header': 1, 'card': 3, 'image': 1, 'heading': 3, 'text': 1, 'navigation_row': 4, 'button': 1}`

## Compose (IR)

- elements: 15
- types: `{'header': 1, 'image': 1, 'heading': 3, 'text': 1, 'card': 3, 'navigation_row': 4, 'button': 1, 'screen': 1}`
- warnings (Mode 2 fallbacks): 14
- token refs: 0
- script chars: 6,110
- createInstance count (Mode 1): 0
- createText count: 4
- createFrame count: 11
