...
- component count (flat): 8
- types: `{'header': 1, 'card': 1, 'heading': 1, 'text': 3, 'button': 2}`

## Compose (IR)

- elements: 9
- types: `{'header': 1, 'heading': 1, 'text': 3, 'button': 2, 'card': 1, 'screen': 1}`
- warnings (Mode 2 fallbacks): 8
- token refs: 0
- script chars: 4,408
