...
- types: `{'header': 1, 'card': 3, 'heading': 3, 'image': 1, 'text': 1, 'list': 1, 'list_item': 3, 'button': 2}`

## Compose (IR)

- elements: 16
- types: `{'header': 1, 'heading': 3, 'image': 1, 'text': 1, 'card': 3, 'list_item': 3, 'list': 1, 'button': 2, 'screen': 1}`
