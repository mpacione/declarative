...
- types: `{'header': 1, 'card': 2, 'heading': 2, 'image': 1, 'table': 1, 'list_item': 6, 'button': 1}`

## Compose (IR)

- elements: 15
- types: `{'header': 1, 'heading': 2, 'image': 1, 'card': 2, 'list_item': 6, 'table': 1, 'button': 1, 'screen': 1}`
- warnings (Mode 2 fallbacks): 14
- token refs: 0
- script chars: 5,166
- createInstance count (Mode 1): 0
- createText count: 2
- createFrame count: 13
