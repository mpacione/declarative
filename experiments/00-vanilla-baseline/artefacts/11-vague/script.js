...
n2.appendChild(n3);
n2.appendChild(n4);
try { n4.characters = "Something cool"; } catch (__e) { __errors.push({eid:"heading-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n4.layoutSizingHorizontal = "FILL";
n2.appendChild(n5);
try { n5.characters = "A fresh way to explore."; } catch (__e) { __errors.push({eid:"text-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
