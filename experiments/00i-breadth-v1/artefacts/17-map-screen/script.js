...
n2.name = "image-1";
n2.fills = [{type: "SOLID", color: {r:0.8863,g:0.9098,b:0.9412}}];
n2.cornerRadius = 8;
...
M["list_item-2"] = n10.id;

const n11 = figma.createFrame();
n11.name = "list_item-3";
...
n3.appendChild(n6);
try { n6.characters = "Nearby Locations"; } catch (__e) { __errors.push({eid:"heading-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n6.layoutSizingHorizontal = "FILL";
n3.appendChild(n7);
n7.layoutSizingHorizontal = "FILL";
n7.layoutSizingVertical = "HUG";
n5.appendChild(n8);
try { n8.characters = "Search locations"; } catch (__e) { __errors.push({eid:"text-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
