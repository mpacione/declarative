...
n12.name = "text_input-1";
n12.layoutMode = "VERTICAL";
n12.itemSpacing = 6;
n12.paddingTop = 10;
n12.paddingRight = 12;
n12.paddingBottom = 10;
n12.paddingLeft = 12;
n12.resize(n12.width, 48);
n12.fills = [{type: "SOLID", color: {r:1.0,g:1.0,b:1.0}}];
n12.strokes = [{type: "SOLID", color: {r:0.7961,g:0.8353,b:0.8824}}];
n12.cornerRadius = 8;
n12.clipsContent = false;
M["text_input-1"] = n12.id;

const n13 = await (async () => { const __src = _p1; if (!__src) { __errors.push({eid:"icon_button-3", kind:"missing_component_node", id:"5749:82310"}); return _missingComponentPlaceholder("icon_button-3", 24, 24, "icon_button-3"); } try { return __src.createInstance(); } catch (__e) { __errors.push({eid:"icon_button-3", kind:"create_instance_failed", id:"5749:82310", error: String(__e && __e.message || __e)}); return _missingComponentPlaceholder("icon_button-3", 24, 24, "icon_button-3"); } })();
n13.name = "icon_button-3";
M["icon_button-3"] = n13.id;
...
n1.appendChild(n4);
n1.appendChild(n5);
try { n5.characters = "Contact Name"; } catch (__e) { __errors.push({eid:"text-1", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
...
n3.appendChild(n13);
n7.appendChild(n14);
try { n14.characters = "Hey, how are you?"; } catch (__e) { __errors.push({eid:"text-2", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n14.layoutSizingHorizontal = "FILL";
n8.appendChild(n15);
try { n15.characters = "I'm doing great! Just finished that project we talked about."; } catch (__e) { __errors.push({eid:"text-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n15.layoutSizingHorizontal = "FILL";
n9.appendChild(n16);
try { n16.characters = "That's awesome! Can't wait to see it."; } catch (__e) { __errors.push({eid:"text-4", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n16.layoutSizingHorizontal = "FILL";
n10.appendChild(n17);
try { n17.characters = "I'll send you the details tomorrow morning."; } catch (__e) { __errors.push({eid:"text-5", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n17.layoutSizingHorizontal = "FILL";
n11.appendChild(n18);
try { n18.characters = "Sounds perfect!"; } catch (__e) { __errors.push({eid:"text-6", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n18.layoutSizingHorizontal = "FILL";
n12.appendChild(n19);
try { n19.characters = "Type a message..."; } catch (__e) { __errors.push({eid:"text-7", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
