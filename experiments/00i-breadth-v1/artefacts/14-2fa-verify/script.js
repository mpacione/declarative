...
n9.name = "text-5";
try { n9.fontName = {family: "Inter", style: "Regular"}; } catch (__e) { __errors.push({eid:"text-5", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
M["text-5"] = n9.id;
...
n11.name = "text-7";
n11.fills = [{type: "SOLID", color: {r:0.9725,g:0.9804,b:0.9882}}];
try { n11.fontName = {family: "Inter", style: "Semi Bold"}; } catch (__e) { __errors.push({eid:"text-7", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n11.fontSize = 14;
M["text-7"] = n11.id;
...
n3.appendChild(n11);
try { n11.characters = "Verify"; } catch (__e) { __errors.push({eid:"text-7", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
n11.layoutSizingHorizontal = "FILL";
n8.appendChild(n12);
try { n12.characters = "Verification Code"; } catch (__e) { __errors.push({eid:"text-3", kind:"text_set_failed", error: String(__e && __e.message || __e)}); }
