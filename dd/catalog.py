...
CATALOG_ENTRIES: tuple[CatalogEntry, ...] = (
    ...
    # ── Content & Display (13) ───────────────────────────────────────────
    {
        ...
        "slot_definitions": {"image": {"allowed": ["image"], "required": False}, "title": {"allowed": ["heading", "text"], "required": False}, "subtitle": {"allowed": ["text"], "required": False}, "body": {"allowed": ["text"], "required": False}, "actions": {"allowed": ["button", "icon_button", "link"], "required": False, "multiple": True}},
    ...
    # ── Navigation (9) ───────────────────────────────────────────────────
    {
        ...
        "aliases": ["app_bar", "top_bar", "nav_bar"],
        "category": "navigation",
        "behavioral_description": "The top bar of a screen containing title, navigation, and actions.",
        "prop_definitions": {"title": "text"},
        "slot_definitions": {"leading": {"allowed": ["icon_button"], "required": False}, "title": {"allowed": ["text", "heading"], "required": False}, "trailing": {"allowed": ["icon_button", "avatar"], "required": False, "multiple": True}},
